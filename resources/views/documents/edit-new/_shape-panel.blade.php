<div class="shape-tool-panel" id="shape-tool-panel">
    ...
    <div class="sfb-control-group sfb-type-group">
        ...
        <div class="sfb-shape-grid" id="shape-type-grid">
            <button type="button" class="sfb-shape-btn is-active" aria-pressed="true" data-shape-tool="circle" title="Circle" aria-label="Circle">
                <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="8"></circle></svg>
            </button>
            <button type="button" class="sfb-shape-btn" aria-pressed="false" data-shape-tool="triangle" title="Triangle" aria-label="Triangle">
                <svg viewBox="0 0 24 24"><path d="M12 5 19 18H5z"></path></svg>
            </button>
            <button type="button" class="sfb-shape-btn" aria-pressed="false" data-shape-tool="square" title="Square" aria-label="Square">
        ...
        <div class="sfb-shape-grid sfb-extra-shapes" id="shape-more-grid">
            ...
            <button type="button" class="sfb-shape-btn" aria-pressed="false" data-shape-tool="x" title="X mark" aria-label="X mark">
                <svg viewBox="0 0 24 24"><path d="M6 6 18 18M18 6 6 18"></path></svg>
            </button>
            <button type="button" class="sfb-shape-btn" aria-pressed="false" data-shape-tool="heart" title="Heart" aria-label="Heart">
    ...
    <div class="sfb-control-group sfb-stroke-group">
        ...
        <label class="sfb-color" title="Stroke color" aria-label="Stroke color">
            <input type="color" id="shape-stroke-color" value="#0f172a" title="Stroke color" aria-label="Stroke color">
        </label>
    ...
    <div class="sfb-control-group sfb-fill-group">
        ...
        <label class="sfb-color" title="Fill color" aria-label="Fill color">
            <input type="color" id="shape-fill-color" value="#22c55e" title="Fill color" aria-label="Fill color">
        </label>
