    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            <router-link to="/" class="logo d-flex align-items-center">
                <img src="{{ asset('images/netkit_logo_cube.svg') }}" alt="Netkit logo" width="30" height="30" style="object-fit: contain;">

                <h1 class="h4 mb-0 ms-2">
                    <strong>Netkit</strong> Horizon{{ config('horizon.name') ? ' - ' . config('horizon.name') : '' }}
                </h1>
            </router-link>
