    ...
    <main class="pt-28 pb-20" x-data="logoGenerator()">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1200px]">
            <div class="text-center mb-10">
                <div class="inline-flex items-center justify-center w-16 h-16 bg-violet-100 dark:bg-violet-900/40 rounded-2xl mb-5">
                    <svg class="w-8 h-8 text-violet-600 dark:text-violet-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15M14.25 3.104c.251.023.501.05.75.082M19.8 15a2.25 2.25 0 01.45 1.318 2.25 2.25 0 01-2.12 2.238 54.627 54.627 0 01-5.88.31 54.627 54.627 0 01-5.88-.31 2.25 2.25 0 01-2.12-2.238c0-.476.167-.934.45-1.318m15 0L14.25 3.104m-9 11.896L9.75 3.104"></path>
                    </svg>
                </div>
                <div class="flex items-center justify-center gap-2.5 mb-3">
                    <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">AI Logo Lab</h1>
                    <span class="px-2 py-1 rounded-full text-[9px] font-bold uppercase tracking-widest bg-violet-100 dark:bg-violet-900/40 text-violet-700 dark:text-violet-300 border border-violet-200 dark:border-violet-700">Experimental</span>
                </div>
                <p class="text-gray-500 dark:text-gray-400 text-lg">Explore models, substyles &amp; advanced parameters — all in one lab</p>
                <div class="mt-4">
                    <a href="{{ route('domainSearch.logoGenerator') }}" class="inline-flex items-center gap-2 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition font-medium">
            ...
            <div id="logo_main" class="flex-1 min-w-0 bg-white dark:bg-gray-900 rounded-2xl shadow-lg shadow-gray-200/50 dark:shadow-black/20 border border-gray-200 dark:border-gray-800 p-6 mb-8">
                @if ($logoUser)
                    {{-- AI Experimentation Lab: Model Selector --}}
                    <div class="mb-5">
                        <div class="flex items-center gap-2 mb-3">
                            <svg class="w-4 h-4 text-violet-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15M14.25 3.104c.251.023.501.05.75.082M19.8 15a2.25 2.25 0 01.45 1.318 2.25 2.25 0 01-2.12 2.238 54.627 54.627 0 01-5.88.31 54.627 54.627 0 01-5.88-.31 2.25 2.25 0 01-2.12-2.238c0-.476.167-.934.45-1.318m15 0L14.25 3.104m-9 11.896L9.75 3.104"></path>
                            </svg>
                            <label class="text-sm font-semibold text-gray-700 dark:text-gray-300">AI Experimentation Lab</label>
                            <span class="px-1.5 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest bg-violet-100 dark:bg-violet-900/30 text-violet-600 dark:text-violet-400 border border-violet-200 dark:border-violet-800">Lab</span>
                        </div>
                        ...
                        <div class="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                            ...
                            <button type="button" @click="logoImageModel = 'flux'; if (!['professional','fantasy','future','retro','greetingcard','custom'].includes(logoStyle)) { logoStyle = 'professional'; } logoIconOnly = false; fetchLogoPrice()"
                                class="w-full flex items-center gap-3 px-4 py-3 transition-all border-b border-gray-200 dark:border-gray-700 text-left"
                                :class="logoImageModel === 'flux' ? 'bg-emerald-50 dark:bg-emerald-900/20' : 'bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800/50'">
                                <div class="flex-shrink-0 w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors"
                                    :class="logoImageModel === 'flux' ? 'border-emerald-500 bg-emerald-500' : 'border-gray-300 dark:border-gray-600'">
                                    <div x-show="logoImageModel === 'flux'" class="w-2 h-2 rounded-full bg-white"></div>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        <span class="text-sm font-semibold" :class="logoImageModel === 'flux' ? 'text-emerald-700 dark:text-emerald-300' : 'text-gray-800 dark:text-gray-200'">Flux Schnell</span>
                                        <code class="text-[10px] font-mono px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400">fal-ai/flux/schnell</code>
                                    </div>
                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Fast open-source diffusion &middot; raster &amp; vectorized SVG output</p>
                                </div>
                                <div class="text-right flex-shrink-0">
                                    <div class="text-xs font-semibold" :class="logoImageModel === 'flux' ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-500 dark:text-gray-400'" x-text="formatCardPrice(modelCardPricePerImage.flux) + ' / img'"></div>
                                    <div class="text-[10px] text-gray-400 mt-0.5">&#x26A1; Fastest</div>
                                </div>
                            </button>
                            ...
                            <button type="button" @click="logoImageModel = 'recraft'; if (!['professional','fantasy','future','retro','greetingcard','custom'].includes(logoStyle)) { logoStyle = 'professional'; } logoIconOnly = false; fetchLogoPrice()"
                                class="w-full flex items-center gap-3 px-4 py-3 transition-all border-b border-gray-200 dark:border-gray-700 text-left"
                                :class="logoImageModel === 'recraft' ? 'bg-emerald-50 dark:bg-emerald-900/20' : 'bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800/50'">
                                <div class="flex-shrink-0 w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors"
                                    :class="logoImageModel === 'recraft' ? 'border-emerald-500 bg-emerald-500' : 'border-gray-300 dark:border-gray-600'">
                                    <div x-show="logoImageModel === 'recraft'" class="w-2 h-2 rounded-full bg-white"></div>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        <span class="text-sm font-semibold" :class="logoImageModel === 'recraft' ? 'text-emerald-700 dark:text-emerald-300' : 'text-gray-800 dark:text-gray-200'">Recraft v3</span>
                                        <code class="text-[10px] font-mono px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400">recraft-ai/recraft-v3</code>
                                    </div>
                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Balanced quality &middot; native SVG vector generation</p>
                                </div>
                                <div class="text-right flex-shrink-0">
                                    <div class="text-xs font-semibold" :class="logoImageModel === 'recraft' ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-500 dark:text-gray-400'" x-text="formatCardPrice(modelCardPricePerImage.recraft) + ' / img'"></div>
                                    <div class="text-[10px] text-gray-400 mt-0.5">&#x1F3A8; Vector-native</div>
                                </div>
                            </button>
                            ...
                            <button type="button" @click="logoImageModel = 'dalle'; logoOutputFormat = 'raster'; if (!['professional','fantasy','future','retro','greetingcard','chrome','8bit','dotmatrix','custom'].includes(logoStyle)) { logoStyle = 'professional'; } if (!['chrome','dotmatrix'].includes(logoStyle)) { logoIconOnly = false; } fetchLogoPrice()"
                                ...
                                :class="logoImageModel === 'dalle' ? 'bg-emerald-50 dark:bg-emerald-900/20' : 'bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800/50'">
                                <div class="flex-shrink-0 w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors"
                                    :class="logoImageModel === 'dalle' ? 'border-emerald-500 bg-emerald-500' : 'border-gray-300 dark:border-gray-600'">
                                    <div x-show="logoImageModel === 'dalle'" class="w-2 h-2 rounded-full bg-white"></div>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        <span class="text-sm font-semibold" :class="logoImageModel === 'dalle' ? 'text-emerald-700 dark:text-emerald-300' : 'text-gray-800 dark:text-gray-200'">DALL-E 3</span>
                                        <code class="text-[10px] font-mono px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400">openai/dall-e-3</code>
                                    </div>
                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Elite text rendering &middot; highest fidelity image quality</p>
                                </div>
                                <div class="text-right flex-shrink-0">
                                    <div class="text-xs font-semibold" :class="logoImageModel === 'dalle' ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-500 dark:text-gray-400'" x-text="formatCardPrice(modelCardPricePerImage.dalle) + ' / img'"></div>
                                    <div class="text-[10px] text-gray-400 mt-0.5">&#x2728; Best text</div>
                                </div>
                            </button>
                        </div>

                        {{-- Per-model config panel --}}
                        <div class="mt-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60 p-3">
                            {{-- Flux settings --}}
                            <div x-show="logoImageModel === 'flux'" x-transition class="space-y-2.5">
                                <p class="text-[10px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500">Flux Settings</p>
                                <div>
                                    <p class="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">Output Format</p>
                                    <div class="flex gap-2">
                                        <button type="button" @click="logoOutputFormat = 'raster'; fetchLogoPrice()"
                                            class="flex-1 px-3 py-2 rounded-lg border-2 text-xs font-medium transition-all text-center"
                                    ...
                                    <p x-show="logoOutputFormat === 'vector'" x-transition class="mt-1.5 text-[10px] text-indigo-500 dark:text-indigo-400">Raster output will be vectorized via post-processing.</p>
                                </div>
                            </div>

                            {{-- Recraft settings --}}
                            <div x-show="logoImageModel === 'recraft'" x-transition class="space-y-2.5">
                                <p class="text-[10px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500">Recraft Settings</p>
                                <div>
                                    <p class="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">Output Format</p>
                                    <div class="flex gap-2">
                                        <button type="button" @click="logoOutputFormat = 'raster'; fetchLogoPrice()"
                                    ...
                                    <p x-show="logoOutputFormat === 'vector'" x-transition class="mt-1.5 text-[10px] text-indigo-500 dark:text-indigo-400">Recraft generates native SVG directly &mdash; no rasterization needed.</p>
                                </div>
                                <div x-show="logoStyle !== 'custom'" x-transition>
                                    <p class="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">Substyle <span class="font-normal text-gray-400">(optional)</span></p>
                                    <div class="flex flex-wrap gap-1.5">
                                        <template x-for="sub in [{id:null,label:'Auto'},{id:'cartoon_illustration',label:'Cartoon'},{id:'line_art',label:'Line Art'},{id:'realistic_image',label:'Realistic'},{id:'digital_illustration',label:'Digital Illus.'},{id:'vector_illustration',label:'Vector Illus.'},{id:'icon',label:'Icon'}]" :key="sub.id || 'auto'">
                                            <button type="button" @click="recraftSubstyle = sub.id; fetchLogoPrice()"
                                                class="px-2.5 py-1.5 rounded-lg border text-xs font-medium transition-all"
                                                :class="recraftSubstyle === sub.id ? 'border-emerald-500 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300' : 'border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-600'"
                                                x-text="sub.label"></button>
                                        </template>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- DALL-E settings --}}
                            <div x-show="logoImageModel === 'dalle'" x-transition class="space-y-2.5">
                                <p class="text-[10px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500">DALL-E Settings</p>
                                <div>
                                    <p class="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">Image Format</p>
                                    <div class="flex gap-2">
                    ...
                    {{-- Output format is now embedded in the AI Lab model config above --}}
