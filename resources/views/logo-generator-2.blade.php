    ...
    <div x-data="logoGenerator()" x-init="init()" class="min-h-screen pt-16 flex flex-col">
        ...
        <div class="flex flex-1 overflow-hidden relative">
            ...
            <div 
                ...
                class="lg:hidden fixed inset-0 top-28 bg-black bg-opacity-50 z-10"
                x-cloak
            ></div>
            ...
            <div 
                ...
                class="w-80 lg:w-96 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 overflow-y-auto fixed lg:relative top-28 lg:top-0 bottom-0 left-0 z-20 lg:z-0"
                x-cloak
            >
