 ...
 * (renderableSourceLines, editableLineStyle, wrapParagraph, blockLineHeightPx)
 ...
 * @param {(text: string, maxWidthPx: number, stylePx: Object) => string[]} deps.wrapParagraph
...
export function configureMeasure(deps) {
    ...
    if (typeof deps.wrapParagraph === 'function') wrapParagraph = deps.wrapParagraph;
